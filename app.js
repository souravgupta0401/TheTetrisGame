   ...
   // console.log(squares)
    ...
    const zTetromino = [
     ...
     // console.log(theTetriminos[0][0]);
      ...
      //makr tetromino move down every second
     // timerId =setInterval(moveDown,1000)
      ...
      //move the tetrimino left unless at edge, or blockage
      function moveLeft(){
          undraw()
...
//const block scope
//var global scope
//Array.from creates array of the selected elememts
...
//in function argument dont need to write the variable type
/*
hello = function(){
    return 'Hello World'
}
...
itemArray.forEach(item=>item+2) // in ascending order
setInterval(fun,time) //invoke function after specified time
move left
check if leftmost or if already occupied
*/